...
// configuration step. It creates a namespace called `cmake_tst_example`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_tst_example::cmake::project_name, cmake_tst_example::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_tst_example::cmake::project_version);
      return EXIT_SUCCESS;
    }
